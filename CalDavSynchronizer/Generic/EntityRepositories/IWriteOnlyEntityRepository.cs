...
namespace CalDavSynchronizer.Generic.EntityRepositories
{
  ...
  public interface IWriteOnlyEntityRepository<TEntity, TEntityId, TEntityVersion>
  {
    ...
    EntityIdWithVersion<TEntityId, TEntityVersion> Update (TEntityId entityId, TEntityVersion version, TEntity entityToUpdate, Func<TEntity, TEntity> entityModifier);
